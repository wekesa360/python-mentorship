# Given a string, find the longest substring, which has all distinct characters
...
def non_repeat_substring(str1):
    ...
    for window_end in range(len(str1)):
        ...
        #so that we have only one occurrance of 'right_char'
        if right_char in char_index_map:
            # this is tricky; in the current window, we still not have any 'right_char' after
